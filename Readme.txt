...
* Once logged in, in the right upper corner of the screen, click on the Administrator button, click on ÒMy AccountÓ button
* A new screen will appear
* Click the Security Tab
* In the token section, enter the token name you want to create, click on the ÒGenerate TokenÓ button, and copy and save the generated token in your local
Step 3:
...
o Copy the password and paste into the ÒAdministrator PasswordÓ block and press ÒContinueÓ
* Choose ÒInstall the suggested pluginsÓ in the next screen
* Enter the requisite information in the next pages (or you can choose to skip those steps) till you donÕt land on the dashboard page
* On the left side of the screen click on ÒManage JenkinsÓ
* In the system configuration section click on ÒManage PluginsÓ 
* Go to the ÒAvailableÓ tab
* Search and tick the following plugins:
o Blue Ocean
o SonarQube Scanner
o HTTP Request
o Pipeline Maven Integration
* Choose ÒInstall without restartÓ option
* Go back to the dashboard
* Go back to ÒManage JenkinsÓ screen, and this time click on ÒConfigure SystemÓ
...
* Select Github
* Paste your Github access token in the text box (it also gives an option to create one, you can click on that option if you donÕt have an access token already)
* Select the organization where the cloned repo is
* Choose the repository
* Choose ÒCreate PipelineÓ option
* The pipeline will be created an executed
* You should a screen with the pipeline build visualized 
* Go to Sonarqube dashboard and you would see a project named ÒpetclinicÓ 
